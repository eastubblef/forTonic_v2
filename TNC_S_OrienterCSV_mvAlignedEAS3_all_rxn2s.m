...
% opposites for directional mvmnts for 171012-171013; actually could use
% the TNC_S_OrienterNS4_CueEAS2.m for those files

% Also, this version  has wheel smoothing offset for ALL files; 
% "perfect" alignment for 170111-170118 is negatively adjusted to hit the velocity change in wheel velocity trace
...
% % smooth_off = 715; %should be this if I'm not convolving
% smooth_off = 480;   %value determined from xvelocity wheel offset in contWheel2.m - should be perfectly aligned with this
...
% smooth_off = -150;   %for hitting the true velocity deflection
smooth_off = 0;   %for hitting the true velocity deflection
...
%     end
    ...
    save([targetName '_bh6RxnSmooth.mat'],'export_mvmt_data_for_psths');                            
    disp(['saved as ' targetName '_bh6RxnSmooth.mat']);
