...
% targetName = '170112NevBoss';
% targetName = '170508laserStim';
% targetName = '151105_newUnits';
targetName = '151105_newUnits2Behave';
...
% initPath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings16_17/170112/4thPass/behaveSegs';
% initPath = '/Users/stubblefielde/Desktop/behaviorFebMarAprMay16/test/170508';
...
taskbaseFile = 'mVgatthree_tb.mat';
...
[source] = strcat(fpath, '*_NEV.mat');
sessNum = 1;

[ContData, filenamestrB] = TNC_MoveBehaveExtractBS_nev(taskbase, filenamestr, targetName, dataRate, chan, elimTime, fpath);  %This will save the extracted recording data of this file to the day of interest (ex: 150529ipsi) as a bh.mat file
...
%% Get TSs for nev-Boss sorted neuronal spikes

[PopData] = TNC_ConvertNEVtoPopDataBS(source, sessNum, fpath);
