...
%  Updated 1.24.17, for older recordings used for SFN poster
clear;
% cd /Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15
cd /Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/older_mvPCAs
...
% [num,txt,raw] = xlsread('2015_psthMatIndsLabel_newUntags2.xlsx', 'tpose');
for j=1:size(raw,1)
