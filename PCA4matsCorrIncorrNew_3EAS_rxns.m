...
S = load('2018_psthMatCorr_Incorr_matrix_rxn');
...
[num,txt,raw] = xlsread('2017_psthMatIndsLabel_4sess_rxn.xlsx', 'tpose');
...
[mappedA,mapping] = compute_mapping(S.psthMatCorr_Incorr4mat_rxn','PCA',4);
