 ...
 function [ContData, filenamestrB] = TNC_MoveBehaveExtractContinuous(taskbase, filenamestr, targetName, dataRate, chan, elimTime, fpath)
%% This is Beth's working version of Josh's extraction code from Tonic_v2 

% UPDATED LAST:
% 1.18.18 - ll 395-425ish: got rid of rx times not calculated for very old data
...
%      trialStartsZeroNS4 = allTrialStartsNS4 - allTrialStartsNS4(1);         %for 161015 (and most sessions), 170321
...
%      trialStartsZeroNS4 = trialStartsZeroNS4(4:end);
     ...
     trialStartsZeroNS4 = allTrialStartsNS4 - allTrialStartsNS4(2);           %for 161005 and 160505 and 170111
