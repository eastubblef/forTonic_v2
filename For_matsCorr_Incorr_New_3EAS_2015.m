...
% ST.psthMat = horzcat(T.psthMatCorr_Incorr4mat, S.psthMatCorr_Incorr4diff); %order of the spreadsheet
% save('ST.psthMat.mat');
save('S.psthMatCorr_incorr4diff.mat');
...
matrixIpsi = matrixA;
matrixContra = matrixB;

save('matrixIpsi.mat');
save('matrixContra.mat');
...
%could throw in the previous units also and show this for representing all 
%choose example units that show greater ipsi v contra activity
