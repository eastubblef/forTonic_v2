%% This script is to be run to call TNC_MoverBehaviorExtractBS & TNC_ConvertTSDtoPopDataBS
...
% Summary:
% Files needed: _tb.mat file (for TS of behavioral data) , TNC_MoverBehaviorExtractBS, openNSxBS, openNEVBS, TNC_ConvertTSDtoPopDataBS (for TSs of neural data)
% PRIOR TO 11.1.15: 
...
%% Define vars for behavioral input to Blackrock
% Inputs
filenamestr = '~';                    
% dataRate = 'ns4';
dataRate = 'ns5';
...
chan.y = 131;                           % now for lick (post 5.1.16); was for motor - also not used for tagging; Josh says corresponds to Ainp = 3
chan.x = [];
% chan.lick = 129                       % lick input - piezo not used prior to 5.1.16
...
% targetName = '151105_update';
% targetName = '151119_untag';
% targetName = '160505_all';
% targetName = '151105new';
targetName = '170112_behave';
...
% initPath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgatthree/2ndpass/better/laserChunks/untagged';
% initPath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgattwo/151118/behaveChunks';
% initPath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgattwo/151119/151119good/behaveChunks/untagged';
% initPath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgatthree/151104/1001/behaveChunks';
% initPath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgatthree/151106/behaveChunks';
% initPath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings16/160505';
initPath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings16/170112';

%% Load the extracted behavior file structure:
% taskbaseFile = 'mVgattwotag_2015_11_18_172457_tb.mat';
% taskbaseFile = 'mVgatthreetag_2015_11_19_17_tb.mat';
% taskbaseFile = 'mVgatthreetag_2015_11_04_15_tb.mat';
% taskbaseFile = 'mVgatfourtag_2016_05_05_16_tb.mat';
% taskbaseFile = 'mVgatthreetag_2015_11_05_14_tb.mat';
taskbaseFile = 'mVgatfive';
...
% fpath = filestr;
fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings16/170112';

[source] = strcat(fpath, '*_tsd.mat');
sessNum = 1;

[ContData, filenamestrB] = TNC_MoveBehaveExtractNew(taskbase, filenamestr, targetName, dataRate, chan, elimTime, fpath);  %This will save the extracted recording data of this file to the day of interest (ex: 150529ipsi) as a bh.mat file
