function NEV = openNEVBS(varargin)
% function NEV = openNEVBS(filenamestrE, read, nosave, nomat, report, fpath)

% Line 161! don't clear vars so that input file is read
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%BS had probs with "BasicHeader" (l.199)... be sure read and write priveledges are turned on in my directory from which the .nev files are called
%BS changed line 162 from Josh's original code to support file loading

% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgat/1505228ipsi/7007';
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Gad2_tag/150602contra/6007/'; 
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/test/';

% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/150529ipsi/'
% fpath = '/Users/stubblefielde/Desktop/m42/';
% load(fpath);

% fpath = varargin{1,6};
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgatthree/2ndpass/better/behaveChunks';
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgattwo/sorted/151118ipsi/2002'
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgattwo/151119/151119good'
        ...
        otherwise
            ...
            if length(temp)>3 && strcmpi(temp(end-3),'.')      
                ...
                if ~isnumeric(varargin{i})
                   ...
                   clear variables;  %have to save the input file BS  7/21/15
%                   clear i
%                   clear NEV
%                   clear NEVver
%                   clear NoMAT
...
if ~exist('fname', 'var')
%     [fname, fpath] = uigetfile('D:\Data\*.nev');                            %BS 
    [fname, path] = uigetfile('*.nev*','select the .nev file', fpath)         %BS
