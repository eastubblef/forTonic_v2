function NEV = openNEVBS_laser2(varargin)
% function NEV = openNEVBS_laser2(filenamestrE, read, nosave, nomat, report, fpath)

% Line 161! don't clear vars so that input file is read
% 1.18.18 updates: ll. 178-180, l. 194
