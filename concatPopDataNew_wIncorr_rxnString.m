...
% targetName = 'psthMatCorr_Incorr_matrix_rxn3';  % this is the saved concatenated matrix
...
psthMatCorr_Incorr4mat_rxn_5 = horzcat(psthMat171013, psthMat171012, psthMat170118, psthMat170111);
psthMatCorr_Incorr4mat_rxn_5Str = horzcat({psthMat171013Str}, {psthMat171012Str}, {psthMat170118Str}, {psthMat170111Str});
...
%     filenamestr = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15;'
     ...
     save([targetName],'psthMatCorr_Incorr4mat_rxn_5');
     save(['strIndices'],'psthMatCorr_Incorr4mat_rxn_5Str');                            

%     save([targetName], 'psthMatAdjust_rxn5');
%     save(['strIndices5'], 'psthMatAdjust_rxn5_str');
%      
