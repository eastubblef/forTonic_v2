...
% UPDATED LAST:
% 5.8.17   - called by MoveScript_contnous2.m for aligning based on diffs (up to 2nd trial only for begining of the gate)... still need to find end of gate for proper trial start
...
%      firstTrialStartNS4 = vecT(firstTrialInd + 1);
     allTrialsNS4 = vecT(Tinds+1);                                          %should be all of the first values of the gate
