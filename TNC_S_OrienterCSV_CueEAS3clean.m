...
%     end
    ...
    save([targetName '_bhCueNew.mat'],'export_mvmt_data_for_psths');                            
    disp(['saved as ' targetName '_bhCueNew.mat']);
