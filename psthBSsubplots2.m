...
function [alignVarMat] = psthBSsubplots2(popFile, behavFile, units, alignVar1, alignVar2)
...
% popFile = strcat(fpath, '/', '151105_all_pop.mat');
% behavFile = strcat(fpath,'/', '151119_untaggedBehave_bh.mat');
% popFile = strcat(fpath, '/', '151119_untaggedBehave_pop.mat');

% behavFile = strcat(fpath,'/', '151119_newUnits2Behave_bh.mat');
% popFile = strcat(fpath, '/', '151119_newUnits2Behave_pop.mat');

% behavFile = strcat(fpath,'/', '151118_newUnits2Behave_bh.mat');
% popFile = strcat(fpath, '/', '151118_newUnits2Behave_pop.mat');

% behavFile = strcat(fpath,'/', '151106_newUnits2Behave_bh.mat');
% popFile = strcat(fpath, '/', '151106_newUnits2Behave_pop.mat');
...
% alignVar2 = ContData.behavior.RrewTrialStarts;
% alignVar1 = wheel_L_first;
% alignVar2 = wheel_R_first;
% alignVar1 = ContData.behavior.trialStartsValid;
% alignVar2 = ContData.behavior.trialStartsValid;
...
%  
        ...
        alignVar2 = alignVar2';
        if j == 1
            alignVarMat(:,j) = alignVar1(j);
            alignVarMat(:,j*2) = alignVar2(j);
        else 
            alignVarMat(:,j+(j-1)) = alignVar1(j);
            alignVarMat(:,j*2) = alignVar2(j);
        end
    end
end
