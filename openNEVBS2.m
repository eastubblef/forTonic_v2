% function varargout = openNEVBS2(varargin)
function [NEV] = openNEVBS2(varargin)


% openNEV
%EAS modified 1.18.18 since my filenames have letters AND numbers in them 
%also deleted the option to save NEV info as a .mat.
