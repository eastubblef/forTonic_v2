...
% targetName = 'testBehave';
% targetName = '151119_untaggedBehave';
...
[ContData, filenamestrB] = TNC_MoveBehaveExtractContinuous(taskbase, filenamestr, targetName, dataRate, chan, elimTime, fpath);  %This will save the extracted recording data of this file to the day of interest (ex: 150529ipsi) as a bh.mat file
