 ...
 function [ContData, filenamestrB] = TNC_MoveBehaveExtractNew_v6(taskbase, filenamestr, targetName, dataRate, chan, elimTime, fpath)
...
% RE-ESTABLISH ACTIVE INPUTS FOR 11.15 DATA (1.14.16 & 1.28.16): 
