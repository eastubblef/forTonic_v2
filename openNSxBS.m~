function NSx = openNSxBS(varargin)
...
% BS - line 129 fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/150529ipsi'
...
% NSxver = '2.1.0'; %changed 6/23/15 from Josh's version

% BS - for utilizing line 129 fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/150529ipsi'
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/150529ipsi/6008'
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/test';
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/recordings15/Vgathree/2ndpass/better/behaveChunks'
...
% fpath = '/Users/stubblefielde/Desktop/mfiles/DudmanLab/data/spikes/SC2';
...
%     [fname, path] = uigetfile('*.ns*','select the m file','E:/matlab')
%     [fname, path] = uigetfile(fpath,' ', '\*.ns*');                       %BS changed 6/23/15 for her data
    [fname, path] = uigetfile('*.ns*','select the .ns file', fpath)
