...
%     psthWin = [1.0e3,2e3];
    ...
    [sink_tmp]   = TNC_ExtTrigWinsEAS(tmpSmooth,times(valid_valid),[750,1000]); %for 170118
    ...
    %Plot the psth and label the unit plotted
    ...
    figure; hold on;
    [sink_tmpL]   = TNC_ExtTrigWinsEAS(tmpSmooth,Ltimes,[750,1000]); %for 170118
    ...
    [sink_tmpR]   = TNC_ExtTrigWinsEAS(tmpSmooth,Rtimes,[750,1000]); %for 170118
