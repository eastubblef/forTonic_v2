...
%       figure(5); subplot(3,3,jj); 
            ...
            [tmpP,x] = hist(mappedA(posInds,1)-mappedA(negInds,1),-0.4:0.02:0.4); %PC1
            hold off; plot(x,tmpP,'-','LineWidth',2,'color',mapName(1,:));
            hold on; plot([0 0],[0 6],'k-'); box off;
            xlabel('Loadings onto PC1', 'FontSize', 24); ylabel('# Neurons', 'FontSize', 24);
            title(labels3{jj});
...
%        figure(6); subplot(3,3,jj+3); 
            ...
            hold off; plot(x,tmpP,'-','LineWidth',2,'color',mapName(1,:));        
            hold on; plot([0 0],[0 6],'k-'); box off;
            xlabel('Loadings onto PC2', 'FontSize', 24); ylabel('# Neurons', 'Fontsize', 24);
...
%                 figure(7); subplot(3,3,jj+6); 
            ...
            hold off; plot(x,tmpP,'-','LineWidth',2,'color',mapName(1,:));        
            hold on; plot([0 0],[0 6],'k-'); box off;
            xlabel('Loadings onto PC3','Fontsize', 24); ylabel('# Neurons', 'Fontsize', 24);
            ylim([0 20]);
